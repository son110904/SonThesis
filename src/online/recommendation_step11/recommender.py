...
_JSON_SCHEMA_HINT = """Trả về JSON với đúng các khóa sau:
{
  ...
  "cv_quality": ["string — nhận xét về chất lượng viết: bullet có quá ngắn/chung chung không, thiếu số liệu/kết quả cụ thể không, vai trò trong dự án có rõ không. KHÔNG nhận xét thứ tự bố cục sections (Contact, Skills, Education, Experience, Projects) — mỗi nghề/ngành có convention riêng."],
  "recommendations": ["string — đề xuất cải thiện CỤ THỂ, gắn trực tiếp với điểm yếu vừa nêu trong cv_quality và missing_skills."],
  "learning_roadmap": [
