...
_SYSTEM_PROMPT = (
    ...
    "2. Mục 'structure_review' (bố cục): CHỈ nhận xét dựa trên các mục THỰC SỰ có/không "
    "có trong 'Nội dung CV gốc' bên dưới. TRƯỚC KHI nói một mục bị 'thiếu', phải kiểm "
    "tra chắc chắn nó KHÔNG xuất hiện — và coi các tên gọi ĐỒNG NGHĨA là cùng một mục ĐÃ "
    "CÓ: Summary/Objective/Profile/About Me/Introduction/Giới thiệu/Mục tiêu nghề nghiệp "
    "(mục tóm tắt đầu CV); Skills/Kỹ năng; Experience/Kinh nghiệm; Education/Học vấn; "
    "Projects/Dự án. Mỗi nhận xét PHẢI chỉ rõ VỊ TRÍ cụ thể (vd 'Mục Học vấn đang đặt "
    "trên Kinh nghiệm, nên đảo xuống dưới', 'Mục Kỹ năng nên đưa lên trước Kinh nghiệm'). "
    "TUYỆT ĐỐI không nói thiếu một mục đã có mặt (dù mang tên khác), và không nhận xét "
    "chung chung kiểu 'bố cục chưa tốt'. Nếu bố cục đã hợp lý, trả về mảng rỗng.\n"
